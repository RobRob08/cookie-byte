...
(function() {
  ...
  function D(d, a) {
    ...
    if (C(d))
      return new H2(w, w);
    if (B2(d))
      return a = D(x2(d), a), new H2(x2(a.g), x2(a.h));
    if (B2(a))
      return a = D(d, x2(a)), new H2(x2(a.g), a.h);
    if (d.g.length > 30) {
      if (B2(d) || B2(a))
  ...
  async runTransaction(e, t, n, r) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        if (__PRIVATE_logDebug(W, "Transaction failed with error:", t2.message, "Retrying:", n2), this.close(), !n2)
...
var __PRIVATE_IndexBackfiller = class {
  ...
  se(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(z, `Processing collection: ${t2}`), this.oe(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
...
function __PRIVATE_decodeResourcePath(e) {
  ...
  if (__PRIVATE_hardAssert(t >= 2, 64408, {
    ...
    return __PRIVATE_hardAssert(e.charAt(0) === J && "" === e.charAt(1), 56145, {
      path: e
  ...
  yn(e) {
    ...
    if (this.mn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.Sn(e2, t2) || !this.bn(this.fn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.fn.length || !this.bn(this.fn[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Nn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.Un(t, s.fieldPath) && isArray(e2))
          r = this.Kn(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Ln(i2), r));
    } else
      n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, Mt, r));
    return n;
  }
  /**
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
    ...
    this.Qi = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
  ...
  async ns() {
    if (this.isPrimary && !this.rs(this.qi, kt)) {
      ...
      if (this.Ki)
        for (const t of e)
          this.Ki.removeItem(this._s(t.clientId));
    }
  }
  /**
  ...
  Yi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(Z).next((t) => {
      if (null !== t && this.rs(t.leaseTimestampMs, qt) && !this.us(t.ownerId)) {
        if (this.es(t) && this.networkEnabled)
          return true;
        if (!this.es(t)) {
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ui.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ci ? this.ci.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.Hi(s).next((e2) => !!e2 || this.Yi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.Mi.enqueueRetryable(() => this.Qi(false)), new FirestoreError(N.FAILED_PRECONDITION, K);
      return n(s);
  ...
  Is(e) {
    return __PRIVATE_primaryClientStore(e).get(Z).next((e2) => {
      if (null !== e2 && this.rs(e2.leaseTimestampMs, qt) && !this.us(e2.ownerId) && !this.es(e2) && !(this.Oi || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(N.FAILED_PRECONDITION, Qt);
    });
  }
  /**
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.Ii.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Ys(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(jt, "EVENT", t.key, t.newValue), t.key === this.eo)
...
var __PRIVATE_BundleLoader = class {
  ...
  Ga(e) {
    ...
    if (e.Qa.namedQuery)
      ...
      e.Qa.document && (this.Wa[this.Wa.length - 1].document = e.Qa.document, ++t);
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < Bt)
    throw new FirestoreError(N.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Ac)
      throw 1 === e.Ac ? e.Sc(`${this._methodName}() can only appear at the top level of your update data`) : e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
